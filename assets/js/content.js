...
window.CONTENT = {
  ...
  hpc: {
    ...
    points: [
      "<b>Novel boot method.</b> Presented <b>Virtual Switch Root</b>, a novel boot method for HPC compute node reprovisioning. The key innovation is leveraging a systemd-nspawn container or QEMU hypervisor to boot a node into a minimal environment, where the node can then reprovision itself from a networked image. This method enables rapid reprovisioning of compute nodes, reducing downtime and improving overall cluster efficiency.",
